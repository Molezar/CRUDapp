            ...
            <c:forEach var="employee" items="${requestScope.emps}">
                <tr class="w3-panel w3-lightblue w3-card-4 w3-round">
                    ...
                    <td class="w3-container w3-center">
                        <a href="${pageContext.request.contextPath}/employees/employee?id=${employee.empID}">Render Employee</a>
                    </td>
                    <td class="w3-container w3-center">
                        <a href="${pageContext.request.contextPath}/employees/employee?id=${employee.empID}">Update</a>
